...
`;
function SongInfo() {
  const { data, loading } = useQuery(QUERY_SONGS, {
        ...
        <div className="jumbotron jumbotron-fluid">
          <div className="row  mx-auto container">
            ...
            <div className="col-12 col-md-8 row m-0 ">
              ...
              {data.songs.map(({ songsId, songsName }) => (
                <div className="col-12 col-md-4" key={songsId}>
                  <div className="card d-flex">{songsName}</div>
                </div>
              ))}
            </div>
          </div>
