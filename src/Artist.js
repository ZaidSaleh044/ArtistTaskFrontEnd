...
`;
function ArtistInfo() {
  const { data, loading } = useQuery(QUERY_ARTISTS, {
        ...
        <div className="jumbotron jumbotron-fluid">
          <div className="row  mx-auto container">
            ...
            <div className="col-12 col-md-8 row m-0 ">
              ...
              {data.artists.map(({ artistId, artistName }) => (
                <div className="col-12 col-md-4" key={artistId}>
                  <div className="card d-flex">{artistName}</div>
                </div>
              ))}
            </div>
          </div>
